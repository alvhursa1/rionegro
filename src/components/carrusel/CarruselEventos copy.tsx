...
export const CarruselEventos: React.FC = () => {
  ...
  return (
    <div className="relative w-screen h-screen bg-[#fefaf1] text-[#004141] overflow-hidden">
      <div className="p-4 md:p-8">
        <h1 className="text-2xl md:text-[1.5rem] font-minion mb-4">Eventos especiales</h1>
        <Select
